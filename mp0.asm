...
.NotGradeB:
        cmp     byte [mygrade], 'C'     ; Check if C student
        jne     .NotGradeC
        mov     dx, Cmsg                ; Print message for C students
        call    dspmsg
        jmp     .mpExit
