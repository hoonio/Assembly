...
;	mov	[_ExplosionOff], eax
	...
	invoke	_AllocMem, dword 67*62*4
	cmp	eax, -1
	je	near .memError
	mov	[_PointQueue], eax
...
.loop1
	...
	mov		ecx, eax
	or		cl, 00000101b
	cmp		cx, 0303h				; check for the wall
	je		NEAR .loop1
...
.InputFlags	arg	2
	...
	;dword _BlockInRegion(dword *MapOff, word Block, word X, word Y, word RegionVal)	
	invoke _BlockInRegion, dword [.MapOff+ebp], bx, word [.X+ebp], word [.Y+ebp], word [.RegionVal+ebp]
